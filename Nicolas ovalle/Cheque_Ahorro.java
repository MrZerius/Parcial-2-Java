	...
	//menu 
		...
		public static void crear_usuario() {
			...
			for(n=1;n<=num;n++){
				...
				System.out.println("\n");
				System.out.println(n+" Digite la fecha de vencimiento del a cuenta: (dia/mes/año) ");
